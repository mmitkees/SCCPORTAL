...
public class MofawadeenRollsBB {
    ...
    public void valueChanged(ValueChangeEvent valueChangeEvent) {
        ...
        BindingContext bindingctx = BindingContext.getCurrent();
                ...
                DCIteratorBinding dciter = bindingsImpl.findIteratorBinding("MofwadeenRollDates1Iterator");//access the iterator by its ID value in the PageDef file
...
//       YearNum = (oracle.jbo.domain.Number)resolveExpression("#{bindings.CourtYear.attributeValue}");
    ...
    public void DatesvalueChanged(ValueChangeEvent valueChangeEvent) {
        ...
        BindingContext bindingctx = BindingContext.getCurrent();
                BindingContainer bindings = bindingctx.getCurrentBindingsEntry();
                DCBindingContainer bindingsImpl = (DCBindingContainer) bindings;
                DCIteratorBinding dciter = bindingsImpl.findIteratorBinding("CourtRollMofwadeenVO_SD1Iterator");//access the iterator by its ID value in the PageDef file
                ViewObject vo =dciter.getViewObject();
